...
class EncoderorthoRNN(Encoder) :
    def __init__(self, vocab_size, embed_size, hidden_size, pre_embed=None) :
        ...
        self.rnn = OrthoLSTM(LSTMCell, input_size=embed_size, hidden_size=hidden_size, num_layers=self.num_layers, batch_first=True)
...
class EncoderorthoRNN(Encoder) :
    def __init__(self, vocab_size, embed_size, hidden_size, pre_embed=None) :
        ...
        self.hidden_size = hidden_size
        self.rnn = LSTM(LSTMCell, input_size=embed_size, hidden_size=hidden_size, num_layers=self.num_layers, batch_first=True)
        self.output_size = self.hidden_size 
