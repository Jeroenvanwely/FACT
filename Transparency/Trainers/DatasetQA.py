...
def get_Babi_1(args=None) :
    ...
    Babi_1_dataset.hidden_size = 128
...
def get_Babi_2(args=None) :
    ...
    Babi_2_dataset.hidden_size = 128
...
def get_Babi_3(args=None) :
    ...
    Babi_3_dataset.hidden_size = 128
